...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  UNIQUE KEY `idArticle` (`idArticle`,`idCouleur`,`idTaille`),
...
INSERT INTO `article` (`idArticle`, `idCouleur`, `idTaille`, `nbEle`) VALUES
(1, 1, 4, 1),
(1, 2, 5, 2),
(1, 3, 4, 2),
(2, 1, 2, 1),
...
CREATE TABLE IF NOT EXISTS `model_article` (
  ...
  `libArticle` varchar(128) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `model_article` (`idArticle`, `libArticle`, `idMarque`, `idCategorie`, `prix`, `details`, `img`) VALUES
...
--
ALTER TABLE `article`
  ADD CONSTRAINT `fk_article` FOREIGN KEY (`idArticle`) REFERENCES `model_article` (`idArticle`),
