...
class Avatar{
    ...
    public function createRandomGridHorizontal(){
        ...
        for ($rowIndex = 0; $rowIndex < $size ; $rowIndex++){
            ...
            for ($colIndex = 0; $colIndex < $size; $colIndex++){
                ...
                // $grid[$size - $colIndex-1][$size-$rowIndex-1] = $RandomColorChoosed;
                ...
                // $grid[$mirroredCellIndexVertical2][$mirroredCellIndexHorizontal2] = $grid[$rowIndex][$colIndex];
    ...
    public function createRandomGridDiagonal(){
